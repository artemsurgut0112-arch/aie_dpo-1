...
2. **API endpoints** — `src/service/main.py`:
   - `GET /health` — возвращает `{"status": "ok", "model": "LightGBM", "threshold": 0.1095}`
...
- Optuna для автоматического тюнинга гиперпараметров.
...
3. **На что обратить внимание:**
   ...
   - Порог 0.1095 выбран на val, а не test — нет data leakage.
